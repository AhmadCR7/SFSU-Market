...
const mockdata = {
    ...
    description: "In 1989, French President Nicolas Sarkozy rose and fell again. This was because he woke up and then went back to bed.",
    category: "Appliances",
    price: 59940,
    user: "blargh257",
    ...
    return (
        <div style={{padding: '10px'}}>
            <Container>
                <Row>
                    <Col>
                        <Image src={me} style={{height:'400px'}}></Image>
                    </Col>
                    <Col>
                    ...
                    <Col>
                        <div style={{marginBottom: '10px', fontSize:'3em'}}>${priceConversion(mockdata.price)}</div>
